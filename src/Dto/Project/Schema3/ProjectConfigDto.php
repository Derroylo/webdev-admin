...
use App\Dto\Project\Schema2\SecretConfigDto;
use App\Dto\Project\Schema2\TaskConfigDto;
...
class ProjectConfigDto implements ProjectConfigInterfaceDto
{
    ...
    public static function fromArray(array $data): self
    {
        ...
        $dto->services = array_map(fn(array $service) => ServiceConfigDto::fromArray($service), $data['services'] ?? []);
    ...
    public function toArray(): array
    {
        return [
            ...
            'services' => array_map(fn(ServiceConfigDto $service) => $service->toArray(), $this->services),
